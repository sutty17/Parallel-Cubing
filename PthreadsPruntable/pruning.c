...
int *indices = malloc(sizeof(int) * NUMTHREADS);
...
void *generateStuff(void *threadArgs){
int flipSlice,twist,parity,symFlipSlice1,sym1,flipSlice1,twist1,parity1;
unsigned long idx,idx1;
Move m;
