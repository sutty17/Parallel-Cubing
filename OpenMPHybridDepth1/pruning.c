...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void solveOptimal(CubieCube cu,int groupID)
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
{
...
FILE *outFile;
#pragma omp parallel num_threads(NUM_THREADS) shared(cu,optimalDist,nodes,tests,movesClaimed,depthDone,groupID) private(outFile,threadMoves)
{
...
#pragma omp barrier
char outFileName[50];
sprintf(outFileName,"OpenMPHybridDepth1Thread%dGroup%dOut.txt",ID,groupID);
